...
ActiveRecord::Schema[7.1].define(version: 2025_08_19_150126) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["activities_id"], name: "index_messages_on_activities_id"
  ...
  add_foreign_key "messages", "activities", column: "activities_id"
